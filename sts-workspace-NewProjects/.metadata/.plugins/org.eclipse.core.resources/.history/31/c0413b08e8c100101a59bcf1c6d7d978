...
public class AuthService {
	...
	public String encodePassword(Map<String,String> request) {
		return passEncoder.encode(request.get("password"));
	}
	...
	public AuthResponse login(AuthRequest request) {
		...
		return new AuthResponse(request.getEmail(),getRole(request.getEmail()),token);
	}
