package com.camdrilee.configuration;
...
import com.camdrilee.filter.JwtRequestFilter;
import com.camdrilee.service.AppUserDetailsService;
...
public class SecurityConfig {
	...
	private UrlBasedCorsConfigurationSource corsConfigurationSource() {
		...
		config.setAllowedMethods(List.of("POST","GET","DELETE","PATCH","OPTIONS"));
