...
public class CategoryService {
	...
	private CategoryResponse convertToResponse(CategoryEntity newCat) {
		CategoryEntity currentCat = categoryRepository.findByCatId(newCat.getCatId()).orElseThrow(()->new RuntimeException("Category not found"));
		return CategoryResponse.builder()
			...
			.totalItem(itemRepository.countByCatEntity(currentCat))
			.build();
	}
